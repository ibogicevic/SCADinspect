...
public class ExprNode extends ASTNode {
  ...
  protected ExprNode(NodeType type, List<ASTNode> children, String string, String id,
      Double number) {
    super(type, children);
    this.string = string;
    this.id = id;
  ...
  public static ExprNode createExprColonExprColonExpr(ExprNode expr1, ExprNode expr2,
      ExprNode expr3) {
  ...
  public static ExprNode createFunctionCall(String id, ArgumentsCallNode argumentsCall) {
    return new ExprNode(Types.FUNCTION_CALL, Collections.singletonList(argumentsCall), null, id,
        null);
  }
