...
public class IssueList {
  ...
  public TableView showList() {
    ...
    for (int i = 0; i < 10; i++) {
      Issue curr = new Issue(Issue.issueType.WARNING, null, 15 + i, "randomIdentifier" + i,
          "description" + i);
      issues.add(i, curr);
    }
    ...
    issueList.getColumns()
        .addAll(typeCol, lineNumberCol, issueIdentifierCol, descriptionCol, codeSnippedCol,
            resourcesCol);
