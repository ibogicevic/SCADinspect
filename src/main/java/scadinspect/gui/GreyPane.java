  ...
  public void switchTour(Integer step) {
    ...
    switch (step) {
      case -1: {
        ...
        messageLabel
            .setText("Welcome to the QuickTour!\nPlease use the buttons below to navigate " +
      ...
      case 0: {
        ...
        messageLabel.setText(
            "Press \"Open file\" to open an new ScadFile or choose \"Open folder\" from the dropdown menu to open a folder.");
        stepLabel.setText(step + 2 + " of 6");
        break;
      }
      case 1: {
        ...
        prev.setVisible(true);
        messageLabel.setText(
            "Press \"Settings\" to access the settings. For example you can enable auto refresh or set the logging level.");
        bottomArea.switchButtons(0);
        stepLabel.setText(step + 2 + " of 6");
        break;
      }
